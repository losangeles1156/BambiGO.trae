...
export const ja: Dictionary = {
  ...
  nodeDetail: {
    ...
    crowdTitle: '混雑の体感',
    crowdPrompt: 'いまの体感は？',
    crowdCommunityLabel: 'みんなの最多',
    crowdReportCountPrefix: '合計 ',
    crowdReportCountSuffix: ' 件',
    crowdEmpty: 'まだ投稿がありません。あなたの体感を選んでください。',
    crowdHistorical: '過去データ',
    crowdTrendLabel: '傾向',
    crowdVeryComfort: 'とても快適',
    crowdComfort: '快適',
    crowdOk: '普通',
    crowdCrowded: '混雑',
    crowdVeryCrowded: '非常に混雑',
    crowdMedium: '普通',
    crowdHigh: '混雑',
    trendUp: '増加中',
    trendDown: '減少中',
