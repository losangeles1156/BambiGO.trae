...
export const en: Dictionary = {
  ...
  nodeDetail: {
    ...
    crowdTitle: 'Crowd Feeling',
    crowdPrompt: 'How does it feel right now?',
    crowdCommunityLabel: 'Most selected',
    crowdReportCountPrefix: 'Total ',
    crowdReportCountSuffix: ' reports',
    crowdEmpty: 'No reports yet. Tap your feeling.',
    crowdHistorical: 'Historical',
    crowdTrendLabel: 'Trend',
    crowdVeryComfort: 'Very Comfortable',
    crowdComfort: 'Comfortable',
    crowdOk: 'Okay',
    crowdCrowded: 'Crowded',
    crowdVeryCrowded: 'Very Crowded',
